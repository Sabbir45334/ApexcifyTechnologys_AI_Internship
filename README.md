# 🚀 ApexcifyTechnologys AI Internship Projects

Welcome to my **AI Internship Projects repository**! 🎉  
This repo contains **two key projects** I completed during my internship at **ApexcifyTechnologys**, showcasing my skills in **Python programming, AI development, and NLP**.  

These projects demonstrate hands-on experience with **machine learning workflows, AI model implementation, and real-time data processing**.

---

## 🎮 Project 1: Rock-Paper-Scissors Game
A Python-based Rock-Paper-Scissors game where the player competes against a computer AI.  

**Features:**
- Randomized AI opponent using Python’s `random` module  
- Score tracking (first to 10 points wins)  
- Replay option to start again or exit  
- User-friendly command-line interface  

**Skills Learned:**
- Control flow (`if-else` statements)  
- Randomization and game logic  
- Score-based loops and input validation  
